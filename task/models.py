...
class Task(models.Model):
    ...
    team = models.ForeignKey(Team, on_delete=models.CASCADE, null=False, blank=False, verbose_name='업무 진행 팀')
...
class SubTask(models.Model):
    id = models.AutoField(primary_key=True)
    team = models.ForeignKey(Team, on_delete=models.CASCADE, null=False, blank=False, verbose_name='하위업무 진행 팀')
